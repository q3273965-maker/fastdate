...
function navigateTo(screenId, mode) {
  ...
  setTimeout(() => {
    ...
    if (screenId === 'screen-home') document.querySelectorAll('#nav-home, .nav-item:first-child').forEach(n => n.classList.add('active'));
    if (screenId === 'screen-matches') document.querySelectorAll('.nav-item:nth-child(2)').forEach(n => n.classList.add('active'));
    if (screenId === 'screen-chat') document.querySelectorAll('.nav-item:nth-child(3)').forEach(n => n.classList.add('active'));
    if (screenId === 'screen-profile') document.querySelectorAll('.nav-item:nth-child(4)').forEach(n => n.classList.add('active'));
  }, prevScreen ? 200 : 0);
